 ...
 public:
  ...
  class Stub GRPC_FINAL : public StubInterface {
   public:
    ...
    ::grpc::Status setup(::grpc::ClientContext* context, const ::DistSSE::SetupRequestMessage& request, ::DistSSE::ExecuteStatus* response) GRPC_OVERRIDE;
    ...
    ::grpc::Status update(::grpc::ClientContext* context, const ::DistSSE::UpdateRequestMessage& request, ::DistSSE::ExecuteStatus* response) GRPC_OVERRIDE;
    ...
    ::grpc::Status cache(::grpc::ClientContext* context, const ::DistSSE::CacheRequestMessage& request, ::DistSSE::ExecuteStatus* response) GRPC_OVERRIDE;
   ...
   private:
    ...
    ::grpc::ClientAsyncResponseReader< ::DistSSE::ExecuteStatus>* AsyncsetupRaw(::grpc::ClientContext* context, const ::DistSSE::SetupRequestMessage& request, ::grpc::CompletionQueue* cq) GRPC_OVERRIDE;
    ::grpc::ClientReader< ::DistSSE::SearchReply>* searchRaw(::grpc::ClientContext* context, const ::DistSSE::SearchRequestMessage& request) GRPC_OVERRIDE;
    ::grpc::ClientAsyncReader< ::DistSSE::SearchReply>* AsyncsearchRaw(::grpc::ClientContext* context, const ::DistSSE::SearchRequestMessage& request, ::grpc::CompletionQueue* cq, void* tag) GRPC_OVERRIDE;
    ::grpc::ClientAsyncResponseReader< ::DistSSE::ExecuteStatus>* AsyncupdateRaw(::grpc::ClientContext* context, const ::DistSSE::UpdateRequestMessage& request, ::grpc::CompletionQueue* cq) GRPC_OVERRIDE;
    ::grpc::ClientWriter< ::DistSSE::UpdateRequestMessage>* batch_updateRaw(::grpc::ClientContext* context, ::DistSSE::ExecuteStatus* response) GRPC_OVERRIDE;
    ::grpc::ClientAsyncWriter< ::DistSSE::UpdateRequestMessage>* Asyncbatch_updateRaw(::grpc::ClientContext* context, ::DistSSE::ExecuteStatus* response, ::grpc::CompletionQueue* cq, void* tag) GRPC_OVERRIDE;
    ::grpc::ClientAsyncResponseReader< ::DistSSE::ExecuteStatus>* AsynccacheRaw(::grpc::ClientContext* context, const ::DistSSE::CacheRequestMessage& request, ::grpc::CompletionQueue* cq) GRPC_OVERRIDE;
    ::grpc::ClientWriter< ::DistSSE::CacheRequestMessage>* batch_cacheRaw(::grpc::ClientContext* context, ::DistSSE::ExecuteStatus* response) GRPC_OVERRIDE;
    ::grpc::ClientAsyncWriter< ::DistSSE::CacheRequestMessage>* Asyncbatch_cacheRaw(::grpc::ClientContext* context, ::DistSSE::ExecuteStatus* response, ::grpc::CompletionQueue* cq, void* tag) GRPC_OVERRIDE;
  ...
  class WithAsyncMethod_setup : public BaseClass {
   ...
   public:
    ...
    ::grpc::Status setup(::grpc::ServerContext* context, const ::DistSSE::SetupRequestMessage* request, ::DistSSE::ExecuteStatus* response) GRPC_FINAL GRPC_OVERRIDE {
      abort();
  ...
  class WithAsyncMethod_search : public BaseClass {
   ...
   public:
    ...
    // disable synchronous version of this method
    ::grpc::Status search(::grpc::ServerContext* context, const ::DistSSE::SearchRequestMessage* request, ::grpc::ServerWriter< ::DistSSE::SearchReply>* writer) GRPC_FINAL GRPC_OVERRIDE {
      abort();
      return ::grpc::Status(::grpc::StatusCode::UNIMPLEMENTED, "");
    }
  ...
  class WithAsyncMethod_update : public BaseClass {
   ...
   public:
    ...
    // disable synchronous version of this method
    ::grpc::Status update(::grpc::ServerContext* context, const ::DistSSE::UpdateRequestMessage* request, ::DistSSE::ExecuteStatus* response) GRPC_FINAL GRPC_OVERRIDE {
      abort();
      return ::grpc::Status(::grpc::StatusCode::UNIMPLEMENTED, "");
    }
  ...
  class WithAsyncMethod_batch_update : public BaseClass {
   ...
   public:
    ...
    ~WithAsyncMethod_batch_update() GRPC_OVERRIDE {
      BaseClassMustBeDerivedFromService(this);
    }
    // disable synchronous version of this method
    ::grpc::Status batch_update(::grpc::ServerContext* context, ::grpc::ServerReader< ::DistSSE::UpdateRequestMessage>* reader, ::DistSSE::ExecuteStatus* response) GRPC_FINAL GRPC_OVERRIDE {
      abort();
      return ::grpc::Status(::grpc::StatusCode::UNIMPLEMENTED, "");
    }
  ...
  class WithAsyncMethod_cache : public BaseClass {
   ...
   public:
    ...
    ~WithAsyncMethod_cache() GRPC_OVERRIDE {
      BaseClassMustBeDerivedFromService(this);
    }
    // disable synchronous version of this method
    ::grpc::Status cache(::grpc::ServerContext* context, const ::DistSSE::CacheRequestMessage* request, ::DistSSE::ExecuteStatus* response) GRPC_FINAL GRPC_OVERRIDE {
      abort();
      return ::grpc::Status(::grpc::StatusCode::UNIMPLEMENTED, "");
    }
  ...
  class WithAsyncMethod_batch_cache : public BaseClass {
   ...
   public:
    ...
    ~WithAsyncMethod_batch_cache() GRPC_OVERRIDE {
      BaseClassMustBeDerivedFromService(this);
    }
    // disable synchronous version of this method
    ::grpc::Status batch_cache(::grpc::ServerContext* context, ::grpc::ServerReader< ::DistSSE::CacheRequestMessage>* reader, ::DistSSE::ExecuteStatus* response) GRPC_FINAL GRPC_OVERRIDE {
      abort();
      return ::grpc::Status(::grpc::StatusCode::UNIMPLEMENTED, "");
    }
  ...
  class WithGenericMethod_batch_update : public BaseClass {
   ...
   public:
    ...
    ~WithGenericMethod_batch_update() GRPC_OVERRIDE {
      BaseClassMustBeDerivedFromService(this);
    }
    // disable synchronous version of this method
    ::grpc::Status batch_update(::grpc::ServerContext* context, ::grpc::ServerReader< ::DistSSE::UpdateRequestMessage>* reader, ::DistSSE::ExecuteStatus* response) GRPC_FINAL GRPC_OVERRIDE {
  ...
  class WithGenericMethod_cache : public BaseClass {
   ...
   public:
    ...
    ~WithGenericMethod_cache() GRPC_OVERRIDE {
      BaseClassMustBeDerivedFromService(this);
    }
    // disable synchronous version of this method
    ::grpc::Status cache(::grpc::ServerContext* context, const ::DistSSE::CacheRequestMessage* request, ::DistSSE::ExecuteStatus* response) GRPC_FINAL GRPC_OVERRIDE {
  ...
  class WithGenericMethod_batch_cache : public BaseClass {
   ...
   public:
    ...
    ~WithGenericMethod_batch_cache() GRPC_OVERRIDE {
      BaseClassMustBeDerivedFromService(this);
    }
    // disable synchronous version of this method
    ::grpc::Status batch_cache(::grpc::ServerContext* context, ::grpc::ServerReader< ::DistSSE::CacheRequestMessage>* reader, ::DistSSE::ExecuteStatus* response) GRPC_FINAL GRPC_OVERRIDE {
